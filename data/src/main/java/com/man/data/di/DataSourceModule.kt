...
import com.man.data.repository.MovieLocalDataSource
import com.man.data.repository.MovieRemoteDataSource
...
class DataSourceModule {
    ...
    @Singleton
    @Provides
    fun providesMovieDAO(db: DatabaseStorage) = db.movieDao()
